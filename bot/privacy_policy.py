...
class week(week_privacypolicy):

    def __init__(week):

        week.privacy = "Privacy Policy for weekbot"
        week.malicious = "Any information we collect is not used maliciously. If any information stated here seems/is misleading, please contact us immediately at info@viliebot.com."
        week.stores = [
            "gulid IDs",
            "gulid Names",
            "channel IDs",
        ...
        week.why_do_we_need_date_and_how_we_use_it = {
        ...
        week.warn = "we can update these terms at any time without notice. continuing to use our services after any changes will mean that you agree with these terms and violation of our terms of service could result in a permanent ban across all of our services"
